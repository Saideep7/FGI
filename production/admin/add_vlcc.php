      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
                                  ...
                                  <div class="col-md-4" style="margin-bottom:10px;">
                                      ...
                                      <form action="<?php $_SERVER['PHP_SELF'];?>" method="post">
                                        <div class="form-group">
                                          <label class="col-form-label" for="vlcc_name">VLCC Name:</label>
                                          <input name="vlcc_name" type="text" class="form-control" id="vlcc_name" placeholder="Enter VLCC Name">
                                        </div>

                                        <div class="form-group">
                                          <label class="col-form-label" for="vlcc_rep">VLCC Representative:</label>
                                          <input name="vlcc_rep" type="text" class="form-control" id="vlcc_rep" placeholder="Enter VLCC Representative Name">
                                        </div>

                                        <div class="form-group">
                                          <label class="col-form-label" for="vlcc_ph">Mobile Number:</label>
                                          <input name="vlcc_ph" type="tel" class="form-control" id="vlcc_ph" placeholder="Enter VLCC Representative Mobile Number">
                                        </div>
          ...
          <!--php conect-->
                                        ...
                                        <div class="form-group">
                                          <label for="rs_name">Select cc</label>
                                          <select id="rs_name" class="form-control" name="rs_name">
                                            <option selected>Choose...</option>
               <!-- php code-->
                                          </select>
                                        </div>
                                        <div class="form-group">
                                          <label for="rs_name">Select RS</label>
                                          <select id="rs_name" class="form-control" name="rs_name">
                                            <option selected>Choose...</option>
               <!-- php code-->
                                          </select>
                                        </div>
                                        <button name="add_vlcc" style="width:150px;" type="submit" class="btn btn-primary btn-lg">Add VLCC</button>
                                      </form>
                                    </div>
                    </div>
                  </div>
