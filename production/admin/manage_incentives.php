        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="admin_dashboard.php" class="site_title"><span>DairyPro feed</span></a>
            </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <p>select <code>users</code> to edit or delete them .</p>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">CC Name</th>
                            <th class="column-title">Orders</th>
                            <th class="column-title">Incentives giving</th>
                            <th class="column-title">Total Incentives</th>
