      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="cc_dashboard.php" class="site_title"><img src="images/bc2.ico"/ width="60px"> <span>DairyPro feed</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="add_product.php"><i class="fa fa-stack-overflow"></i>New Product<span class="fa fa-chevron-down"></span></a>
                  </li>
                  ...
                  <li><a href="manage_orders.php"><i class="fa fa-shopping-basket"></i>My orders <span class="fa fa-chevron-down"></span></a>
                  </li>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Total Issues</span>
